...
export const DEFAULT_POLL_INTERVALS_MINUTES = {
  sentinel:        5,
  conductor:       15,
  merchant:        60,
  dev:             60,
 ...
 */
export function getPollInterval(agentId) {
 ...
 */
export function setPollInterval(agentId, minutes) {
 ...
 */
export function resetPollInterval(agentId) {
  const key = `agent_poll_interval_${agentId}`;
