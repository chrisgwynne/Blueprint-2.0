...
- Provider/model preflight cache and agent-run blocking
...
- Provider preflight is implemented as a safe gate but not a full live capability probe for every provider.
