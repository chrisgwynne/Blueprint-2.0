...
function getColor(value, goodThreshold, needsWorkThreshold, invert) {
  if (invert) {
...
function getStatus(value, goodThreshold, needsWorkThreshold, invert) {
  if (invert) {
 ...
 */
function Gauge({ value, max = 100, goodThreshold, needsWorkThreshold, label, unit = '', invert = false }) {
